...
func update_panel(hero: HeroData) -> void:
	...
	strength_label.text = str(hero.strength)
	dexterity_label.text = str(hero.dexterity)
	intelligence_label.text = str(hero.intelligence)
	charisma_label.text = str(hero.charisma)
